...
R4 — every query returning catalogs eager-loads all five collections in the same round trip.
...
class CatalogRepository:
    ...
    async def load_catalog_by_id(self, catalog_id: uuid.UUID) -> Catalog:
        ...
        None — see `conventions/coding-standards.md` §2."""
    ...
    async def fetch_catalog_by_self_href(self, href: str) -> Catalog | None:
        ...
        from registry.db.models.link import Link  # noqa: PLC0415 — avoids a circular import
